    ...
    >
      ...
      <div>
        <Typography.H3 className="text-white font-semibold text-center mb-12">
          <>
            <Typography.H2 className=" font-normal font-wc-rough-trad text-[#f2f3f7] text-[clamp(3.5rem,5vw,6rem)]">
            Call for Sponsors 
           </Typography.H2>
            <br/> Interested in partnering with HackNXT?
            <br/>
            <a
              href="mailto:itsa@sggs.ac.in"
              className="ml-2  decoration-2"
            >
